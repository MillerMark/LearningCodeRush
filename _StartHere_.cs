namespace CapsModifier
{
  class _StartHere_
  {
    ...
    Many of the features in this project rely upon Caps as a Modifier, 
    ...
    enabled):
		...
		Note that while the examples in this project highlight fast ways to 
		instantly invoke your favorite refactorings and code generations, all 
		of these features and more can be accessed through Visual Studio's 
		Code Action menu by hitting Ctrl+Dot or Num 0 (if enabled in the Setup 
		Wizard).
