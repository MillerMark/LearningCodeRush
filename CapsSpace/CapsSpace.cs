...
namespace CapsModifier
{
	...
	/* 
	 ...
	 to functions, expand lambda functions, and more.
		...
		![](BtnShowMe;crcommand:OpenFile:ImplicitExplicit.cs) << Guided path
	 ...
	 All Examples (click one to try):
		...
		![](BtnInlineLambda;crcommand:OpenFile:InlineLambda.cs)
	...
	*/
	 ...
	 //`![](NextLesson;crcommand:OpenFile:CapsDelete.cs)  << Caps+Delete to remove unnecessary or redundant code
